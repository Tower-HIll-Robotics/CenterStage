    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (headlessMode) {
                ...
                if (currentGamePad2.dpad_down || currentGamePad1.a) {
                    wheelMotor.setPower(0.8 * wheelMotorPower);
                }
                else if (currentGamePad2.dpad_up || currentGamePad1.y) {
                    wheelMotor.setPower(-0.8 * wheelMotorPower);
                }
                else {
                ...
                else if (currentGamePad2.right_bumper && !currentGamePad2.left_bumper ) {
                    boxRotator.setPower(-0.5);
                }
                else {
